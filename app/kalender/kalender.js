define(["require", "exports"], function (require, exports) {
    ...
    let tahun_skrg = 2018;
    var bulan_label = document.getElementById('bulan');
    var tahun_label = document.getElementById('tahun');
    var tabel = document.getElementById('tgl');
    var input_bulan = document.getElementById('src_bulan');
    var input_tahun = document.getElementById('src_tahun');
   
    exports.value = "fajar-apps";
